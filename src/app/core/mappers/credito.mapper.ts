...
export class CreditoMapper {
  ...
  static toCuotaDomain(dto: CuotaDTO): Cuota {
    return {
      ...
      capital: dto.capital,
      interes: dto.interes,
      interesMora: dto.interesMora || (dto as any).interes_mora,
      penalidad: dto.penalidad || (dto as any).penalidad,
      comision: dto.comision || (dto as any).comision,
      seguro: dto.seguro,
      cargoRefinanciamiento: dto.cargoRefinanciamiento || (dto as any).cargo_refinanciamiento,
